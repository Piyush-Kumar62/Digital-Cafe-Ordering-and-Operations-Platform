...
public class User extends BaseEntity {
    ...
    private Cafe cafe;
        ...
        /* ============================================================
       STAFF MANAGEMENT FIELDS (Used ONLY for CHEF / WAITER roles)
       These remain NULL for CUSTOMER / ADMIN / others.
       ============================================================ */

    @Column(name = "employee_code", length = 30)
    private String employeeCode;   // Optional internal ID (ex: STF-101)
