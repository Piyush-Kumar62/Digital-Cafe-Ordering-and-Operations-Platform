...
export const routes: Routes = [
  ...
  path: "owner",
  loadComponent: () =>
    import("./features/cafe-owner/owner-layout/owner-layout.component")
  ...
  children: [
    {
      path: "setup",
      loadComponent: () =>
        import("./features/cafe-owner/setup-cafe/setup-cafe.component")
          .then(m => m.SetupCafeComponent)
    },
    {
      path: "dashboard",
      loadComponent: () =>
        import("./features/cafe-owner/owner-dashboard/owner-dashboard.component")
          .then(m => m.CafeOwnerDashboardComponent)
    },
    {
      path: "menu",
      loadComponent: () =>
        import("./features/cafe-owner/owner-menu/owner-menu.component")
          .then(m => m.OwnerMenuComponent)
    },
    {
      path: "tables",
      loadComponent: () =>
        import("./features/cafe-owner/owner-tables/owner-tables.component")
          .then(m => m.OwnerTablesComponent)
    },
    {
      path: "staff",
      loadComponent: () =>
        import("./features/cafe-owner/owner-staff/owner-staff.component")
          .then(m => m.OwnerStaffComponent)
    },
    {
      path: "orders",
      loadComponent: () =>
        import("./features/cafe-owner/owner-orders/owner-orders.component")
          .then(m => m.OwnerOrdersComponent)
    },
    {
  path: "settings",
  loadComponent: () =>
    import("./features/cafe-owner/owner-settings/owner-settings.component")
      .then(m => m.OwnerSettingsComponent)
} ,
    { path: "", redirectTo: "dashboard", pathMatch: "full" },
  ],
}
